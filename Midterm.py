...
for i,j,k in os.walk('coord_seligFmt/'):
    ...
    for i,j in enumerate(k):       
        ...
        plt.vlines(x = x[location[0]+maxthicknesslocation[0]],ymin=down[maxthicknesslocation[0]],ymax=up[maxthicknesslocation[0]],label='Maximum Thickness')
